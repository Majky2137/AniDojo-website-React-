...
return(
      ...
      <motion.div drag="x" dragConstraints={{ right: 0, left: -2101  }} className='carousel'>
        {mainbase[0].map((item) => {
    ...
    </motion.div><ModalVideo channel='youtube' autoplay isOpen={this.state.isOpen} videoId={this.state.currentVideoId} onClose={() => this.setState({ isOpen: false })} /></>
